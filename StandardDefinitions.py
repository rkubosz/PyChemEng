...
ExtendedHydrocarbonCombustionComponents = StandardCombustionComponents + {"HCO", "CH2O", "CH4", "CH3", "HO2", "NO2", "NH3", "NH2", "N", "HCN", "CN", "N2O", "C2", "CH"}
RichSootingProducts = ExtendedHydrocarbonCombustionComponents + {"C2H4", "C2H2", "NH", "CH", "CH2", "C(S)"}
